...
export function NewDeckDialog() {
  ...
  const handleCreate = () => {
    ...
    startTransition(async () => {
      // Projeto é só inglês: áudio sempre en-US quando ligado.
      await createDeck(name.trim(), description.trim(), audioOn ? 'en-US' : null);
      setName('');
      setDescription('');
      setAudioOn(false);
      setOpen(false);
